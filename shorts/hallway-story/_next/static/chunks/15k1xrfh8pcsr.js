(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    let n = e.r(8193).createRenderSearchParamsFromClient;
    ("function" == typeof r.default ||
      ("object" == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
      (Object.defineProperty(r.default, "__esModule", { value: !0 }),
  ...
  (e, t, r) => {
    ...
    let n = e.r(89224).createRenderParamsFromClient;
    ("function" == typeof r.default ||
      ("object" == typeof r.default && null !== r.default)) &&
      void 0 === r.default.__esModule &&
      (Object.defineProperty(r.default, "__esModule", { value: !0 }),
  ...
  (e, t, r) => {
        ...
        switch (n.type) {
          ...
          case "validation-client":
            return (function (t, r, n) {
              var a;
              let { createExhaustiveSearchParamsProxy: o } = e.r(32946);
    ...
    function v(t, r, n, a) {
      ...
      if (n.validationSamples) {
        let { createExhaustiveSearchParamsProxy: a } = e.r(32946),
  ...
  (e, t, r) => {
          ...
          case "request":
            if (s.asyncApiPromises && s.validationSamples)
              return (function (t, r, n, a, o) {
                let { createExhaustiveParamsProxy: i } = e.r(32946),
    ...
    function O(t, r, n) {
      let { createExhaustiveParamsProxy: a } = e.r(32946);
      return Promise.resolve(
        a(
          t,
  ...
  (e, t, r) => {
    ...
    function l({ Component: t, serverProvidedParams: r }) {
      ...
      if ("u" < typeof window) {
        let r,
          a,
          { createSearchParamsFromClient: o } = e.r(2800);
        r = o(c);
        let { createParamsFromClient: i } = e.r(53966);
        return ((a = i(u)), (0, n.jsx)(t, { params: a, searchParams: r }));
      }
      {
        let { createRenderSearchParamsFromClient: r } = e.r(81656),
          a = r(c),
          { createRenderParamsFromClient: o } = e.r(76490),
          i = o(u);
  ...
  (e, t, r) => {
    ...
    function i({ Component: t, slots: r, serverProvidedParams: s }) {
      ...
      if ("u" < typeof window) {
        let { createParamsFromClient: a } = e.r(53966),
          o = a(l);
        return (0, n.jsx)(t, { ...r, params: o });
      }
      {
        let { createRenderParamsFromClient: a } = e.r(76490),
          o = a(l);
        return (0, n.jsx)(t, { ...r, params: o });
      }
    }
